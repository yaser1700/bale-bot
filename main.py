...
# =========================================================
# اطلاعات تماس و بروزرسانی
# =========================================================

PHONE = "شماره تماس را اینجا وارد کنید"
WEBSITE = "https://example.com"

LAST_UPDATE = "۱۴۰۵/۰۶/۰۳"
...
def process_message(message):
    ...
    if text == "🕐 آخرین بروزرسانی":

        send_message(

            chat_id,

            "🕐 آخرین بروزرسانی لیست قیمت‌ها:\n\n"
            f"📅 {LAST_UPDATE}"
        )
